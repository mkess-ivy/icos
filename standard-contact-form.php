...
$vf_config = array(
     ...
     */
    'emailRecipients' => 'referrals@icoservices.org',
...
$subject = 'Community Outreach Contact Form - New Message from '.$vfSender->data['name'];

// Define here content of the e-mail message
$content = "Hey,
You've received a new message from the ICOS website. Check the details below:
